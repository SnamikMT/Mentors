<template>
  <NuxtLayout name="app">
    <!-- Жёстко 100vh для всей страницы -->
    <div class="h-screen flex flex-col">
      <!-- Шапка -->
      <PageHeader class="hidden lg:block flex-none" />
      ...
      <div class="flex-1 flex flex-col relative">
        ...
        <div class="pt-4 lg:pt-6">
          ...
          <div class="w-full">
            <div
              class="font-medium text-[#C3C3C3]
                     text-[28px] sm:text-[34px] lg:text-[48px]
                     leading-[36px] sm:leading-[44px] lg:leading-[48px]"
            >
              Следующий звонок
            </div>
            <div
              class="font-medium text-[#020203] mt-2
                     text-[28px] sm:text-[34px] lg:text-[48px]
                     leading-[36px] sm:leading-[44px] lg:leading-[48px]"
            >
          ...
          <!-- CTA -->
          <div class="mt-6 lg:mt-8 flex flex-col sm:flex-row gap-3">
            <AppButton
              size="lg"
        ...
        <!-- НИЖНИЙ БЛОК: две плашки -->
        <div
          class="mt-10 lg:mt-[64px] mb-6 lg:mb-4
                 flex flex-col lg:flex-row gap-3 lg:gap-[12px]"
        >
          <!-- Первая карточка -->
          <div
            class="w-full lg:max-w-[498px] h-auto lg:h-[196px]
                   p-5 lg:p-6 bg-Backgrounds-Neutral-Grouped-Secondary
                   rounded-[24px] lg:rounded-[32px]
                   outline outline-1 outline-offset-[-1px] outline-[#7878801a]
                   backdrop-blur-xl flex flex-col justify-between gap-4 relative"
          >
            <img
              :src="chevronUpIcon"
              alt="calendar toggle"
            ...
            <div class="flex flex-col gap-4 w-full">
              <div class="flex justify-between items-start w-full">
                ...
                <div class="w-6 h-6 relative overflow-hidden shrink-0">
                  <div
                    class="w-3.5 h-2 absolute left-[5px] top-[7.8px]
                           bg-Labels-Neutral-Secondary/70"
                  ></div>
                </div>
              </div>
              ...
              <div class="flex flex-col gap-3 w-full">
                <div class="flex justify-between w-full">
                  <div class="flex items-center gap-1">
                    ...
                    <div class="text-base font-normal text-Labels-Neutral-Primary leading-normal">
                      1
                    </div>
                  </div>
                  <div class="flex items-center gap-1">
                    <img :src="cameraIcon" class="w-4 h-4" alt="cam2" />
                    <div class="text-base font-normal text-Labels-Neutral-Secondary/70 leading-normal">
                      4 осталось
                    </div>
                  </div>
                </div>
            ...
            <div class="flex flex-wrap gap-2">
              ...
              <button
                class="px-4 py-2 text-[rgb(0,122,255)] rounded-full font-medium text-sm border border-transparent"
              >
                Ввести сертификат
              </button>
            </div>
          ...
          <div
            class="w-full lg:max-w-[498px] h-auto lg:h-[196px]
                   ...
                   rounded-[24px] lg:rounded-[32px]
                   outline outline-1 outline-offset-[-1px] outline-[#7878801a]
                   backdrop-blur-xl flex justify-between gap-4"
          >
            <div class="flex flex-col justify-between">
              ...
              <button
                class="mt-4 px-4 py-2 text-[#020203] bg-[#F2F2F7]
                       rounded-full font-medium w-max text-sm"
              >
                Читать гайд
              </button>
            </div>
            <div
              class="relative top-0 -right-2 lg:-right-6
                     h-[120px] sm:h-[150px] lg:h-full
                     w-[160px] sm:w-[190px] lg:w-[218px]"
            >
              <img
                :src="guideImg"
                alt="guide"
        ...
        <!-- ДЕСКТОПНЫЙ календарь: поповер, снизу слева (16px от низа экрана) -->
        <Transition name="fade-up">
          <Calendar
            v-if="isCalendarOpen && isDesktop"
            class="absolute left-0 bottom-4 z-[70]"
            @close="isCalendarOpen = false"
          />
        </Transition>
      </div>

      <!-- МОБИЛЬНЫЙ календарь: полноэкранный -->
      <teleport to="body">
        <div
          v-if="isCalendarOpen && !isDesktop"
