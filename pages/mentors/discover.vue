<template>
  ...
  <div class="w-full max-w-[1440px] bg-Backgrounds-Neutral-Primary flex flex-col lg:flex-row gap-0 lg:gap-12 overflow-hidden">
    ...
    <!-- Мобильный Header -->
    <MobileHeader class="lg:hidden" title="Менторы" />

    <!-- Контент 1008 -->
    <div class="w-full lg:max-w-[1008px] px-4 sm:px-6 lg:pl-[48px] lg:pr-6 pt-4 lg:pt-6 flex flex-col">
      <!-- Десктопный заголовок (если нужен – оставляем скрытым на мобилке) -->
      ...
      <!-- Верхний блок: заголовок + карточка видео -->
      ...
      <div class="mt-6 sm:mt-9 mb-6 sm:mb-9">
        <div class="flex flex-col sm:flex-row gap-3 sm:gap-2">
          <!-- На мобилке — скроллящиеся чипы, на sm+ — сегменты -->
          <div class="sm:flex-1">
...
/* чипы на мобилке */
.chip{
  @apply inline-flex items-center h-10 px-4 rounded-full bg-white border text-[#101012]
         text-[16px] leading-[24px] tracking-[-0.25px];
  border-color: rgba(120,120,128,0.16);
}
