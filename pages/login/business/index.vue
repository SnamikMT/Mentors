    ...
    >
      ...
      <section class="w-full max-w-[760px] py-10 lg:py-16">
        ...
        <div class="form-col mt-8">
          <!-- Email: плавающий лейбл на бордере -->
          <div>
      ...
      <!-- Иллюстрация: всегда справа-снизу, крупная, без фона -->
      <img
        :src="loginImage"
...
<style scoped>
/* Единый столбец: всё ровно и одной ширины */
.form-col{
  display: flex;
