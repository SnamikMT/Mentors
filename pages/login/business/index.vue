    ...
    <div class="relative flex flex-1">
      ...
      <div class="relative z-10 w-1/2 px-32 pb-6 flex flex-col">
       ...
       <button class="mt-1 p-4 bg-white rounded-2xl w-full flex justify-center items-center gap-2 outline outline-1 outline-gray-200">
        ...
        <div class="mt-auto p-4 w-96 text-center">
        ...
        <button class="mt-3 p-4 bg-[#787880]/10 rounded-2xl w-full flex justify-center items-center gap-2">
...
const goToPin = () => {
  if (mail.value.trim()) {
    router.push('/login/business/pin')
  } else {
