<template>
  ...
  <div class="w-full max-w-[1440px] bg-Backgrounds-Neutral-Primary flex flex-col lg:flex-row gap-0 lg:gap-12 overflow-hidden">
    ...
    <!-- Контент -->
    <div class="w-full lg:max-w-[1008px] px-4 sm:px-6 lg:pl-[48px] lg:pr-6 pt-4 lg:pt-6 flex flex-col gap-4">
      <!-- Десктоп: назад + заголовок в шапке -->
      <div class="hidden lg:flex items-center gap-3">
        <button
          type="button"
          @click="goBack"
          class="h-9 w-9 rounded-full border border-[#787880]/10 grid place-items-center hover:bg-black/[0.03] transition"
          aria-label="Назад"
        >
      ...
      <!-- Две колонки: слева видео и прогресс, справа конспект (на мобилке ниже) -->
      <div class="grid grid-cols-1 lg:grid-cols-[1fr,380px] gap-4 lg:gap-6 items-start">
        <!-- Левая колонка -->
            ...
            <div class="absolute inset-x-0 bottom-0 p-4 bg-gradient-to-t from-black/50 to-transparent">
              ...
              <div class="mt-3 flex items-center justify-between">
                <div class="flex items-center gap-3">
                  <img :src="iconPlay" class="w-5 h-5" alt="" />
                  <img :src="iconVolume" class="w-5 h-5" alt="" />
                </div>
                <img :src="iconScreen" class="w-5 h-5" alt="" />
              </div>
            </div>
          </div>
