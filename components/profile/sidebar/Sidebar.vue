<template>
  <!-- Сайдбар виден только ≥ lg -->
  <div
    class="hidden lg:flex w-[256px] min-w-[256px] max-w-[256px] shrink-0 box-border self-stretch px-3 py-6 bg-[#F9F9FA] flex-col"
  >
    ...
    <div class="self-stretch h-0 outline outline-1 outline-offset-[-0.5px] outline-[#787880]/10 mb-2"></div>
