  ...
  <div class="w-full flex justify-center">
    <div class="w-full max-w-[1008px] flex flex-col gap-6">
      ...
      >
        ...
        <div class="px-4 lg:px-6 flex flex-col gap-3">
      ...
      <!-- Конфиденциальность -->
      <section
        class="relative rounded-[24px] lg:rounded-[32px] bg-Backgrounds-Neutral-Primary border border-Border-Neutral-Base/20 px-4 lg:px-6 pt-7 lg:pt-9 pb-5 lg:pb-6 flex flex-col gap-3"
      >
        <div class="inline-flex items-center gap-2">
          <button
            type="button"
